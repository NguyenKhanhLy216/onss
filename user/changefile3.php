...
<body>
    ...
    <!--định dạng và kiểm soát vị trí , đặt nền thành màu trắng
    Đặt padding=0-->
...
{               ?>
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputEmail2" class="form-label">Xem File3 cũ</label>
                                   <a href="folder3/<?php echo $row->file3;?>" width="100" height="100" target="_blank"> <strong style="color: red">Xem file cũ</strong></a>


                                </div>
                               
                                <div class="mb-3">
                                    <label for="exampleInputEmail2" class="form-label">Tải lên file mới</label>
            ...
            <!-- Form End -->
             ...
             <?php include_once('includes/footer.php');?><!--gắn tệp footer.php vào trang hiện tại-->

        </div>
        <!-- Content End -->


       <?php include_once('includes/back-totop.php');?><!--gắn tệp back-totop.php vào trang hiện tại-->
